/**
 * Capabilities Services - Application Layer Export
 *
...
/**
 * Capabilities Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for capabilities domain.
 */
