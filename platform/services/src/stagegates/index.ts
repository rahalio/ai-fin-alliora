/**
 * Stagegates Services - Application Layer Export
 *
...
/**
 * Stagegates Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for stagegates domain.
 */
